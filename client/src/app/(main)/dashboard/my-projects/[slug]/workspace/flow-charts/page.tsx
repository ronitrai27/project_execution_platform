      ...
      <header className="flex items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Map out architectures, system designs, and user journey workflows.
          </p>
        </div>
          ...
          <div className="space-y-2.5 w-full">
            <div>
              ...
              <p className="text-muted-foreground text-sm lg:text-[15px] leading-relaxed">
                Visual diagramming and flow-chart tools are coming soon! Draw database
                schemas, process maps, and component trees collaboratively.
              </p>
            </div>
